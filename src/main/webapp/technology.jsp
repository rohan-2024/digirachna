...
<head>
    ...
    <title>Technology - DigiRachna</title>
    ...
    <style>
        ...
        .category-header {
            background: url('img/headerTechnology.jpg') no-repeat center center/cover;
            height: 60vh;
            color: #fff;
            display: flex;
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="categories.jsp">Categories</a></li>
    ...
    <section class="category-header">
        <div>
            ...
            <h1>Technology</h1>
            <p>Explore the latest trends, innovations, and insights in the tech world.</p>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card article-card">
                        <img src="img/ai2.jpg" class="card-img-top" alt="Article Image 1">
                        <div class="card-body">
                            <h5 class="card-title">The Future of Artificial Intelligence</h5>
                            <p class="card-text">How AI is transforming industries and what lies ahead.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card article-card">
                        <img src="img/5g.jpg" class="card-img-top" alt="Article Image 2">
                        <div class="card-body">
                            <h5 class="card-title">5G Technology: What You Need to Know</h5>
                            <p class="card-text">An in-depth look at the benefits and challenges of 5G.</p>
                            <div class="d-flex justify-content-between align-items-center">
                            <a href="#" class="btn btn-warning">Read More</a>
                            <span class="text-muted"><i class="fas fa-eye"></i> 2,345 views</span>
                            </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card article-card">
                        <img src="img/electricVehicle.jpg" class="card-img-top" alt="Article Image 3">
                        <div class="card-body">
                            <h5 class="card-title">The Rise of Electric Vehicles</h5>
                            <p class="card-text">Exploring the impact of EVs on transportation and the environment.</p>
                             <div class="d-flex justify-content-between align-items-center">
                            <a href="#" class="btn btn-warning">Read More</a>
                            <span class="text-muted"><i class="fas fa-eye"></i> 2,345 views</span>
                            </div>
                ...
                <%
                    for(Blog b:blogList){
                        if(b.getCategory().equals("Technology") && b.getStatus().equals("Published")){
                %>
                <div class="col-md-4 mb-4">
                    <div class="card article-card">
