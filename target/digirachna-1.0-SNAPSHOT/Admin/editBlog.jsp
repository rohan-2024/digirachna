...
<div class="container-fluid py-4 px-4 bg-light">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="text-primary">Edit Blog Status</h2>
   </div>
    ...
    <div class="editor-container shadow-sm">
      <div class="toolbar mb-2">
        ...
        <textarea name="content" readonly class="form-control shadow-sm" rows="15" ><%= blog.getContent() %></textarea>
    </div>
  
    <!-- Post Options -->
    <div class="row mt-4">
      <div class="col-md-6 mb-3">
          <input type="text" value="<%= blog.getCategory() %>" name="category" hidden >
          Category: <%= blog.getCategory() %></label>
     ...
     <button type="submit" class="btn btn-primary shadow-sm">Submit</button>
        ...
        <div class="header-section">
            ...
            <p class="subtitle">comments on this blog post.</p>
